...
main = Tk()
main.title("Fish Disease Detection Using Machine Learning Techniques")
...
font = ('times', 15, 'bold')
title = Label(main, text='Fish Disease Detection Using Machine Learning Techniques')
title.config(bg='#03045e', fg='#caf0f8')  
...
preprocessButton = TkinterCustomButton(text="Split Data Set", width=300, corner_radius=5, command=preprocessDataset)
...
svmButton = TkinterCustomButton(text="Run SVM Algorithm", width=300, corner_radius=5, command=trainSVM)
svmButton.place(x=400,y=200)
